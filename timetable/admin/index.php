...
<div class="col-md-5" align="center">
	    ...
	    <h1 class="form-signin-heading"><font color="#FFFFFF" size="+6">Admin Login</font></h2>
        <h3><?php echo $err; ?></h3>
        ...
        <input type="submit" value="Login " name="save" style="background-color:#09f;height:50px;width:350px"/>
