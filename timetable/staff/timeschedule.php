...
function getSubjectsByTeacherId($teacher_id) {
    global $pdo; // Make the $pdo object available inside the function

    try {
        // Prepare the SQL query
        $query = "SELECT subject_name FROM subject WHERE teacher_id = :teacher_id";
...
$teacher_subjects = getSubjectsByTeacherId($teacher_id); // You should replace this with your method.
