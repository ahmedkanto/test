...
$query="update teacher set name='$n',eid='$e',password='$p',mob='$m',address='$a',sem_id='$semester'  where teacher_id='".$_SESSION['teacher_id']."'";
...
<div class="col-md-5"> 
               ...
               <h2><font color="#000000">Update Profile</font></h2>
<form method="POST" enctype="multipart/form-data">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
    ...
    <tr>
    <th width="237" scope="row"><font color="#000000">Term Name</font> </th>
    <td width="213">
