...
<div class="col-md-5" align="center">
	    ...
	    <h1 class="form-signin-heading"><font color="#00000" size="+6">Student Login</font></h2>
         <h3><?php echo $err; ?></h3>
        ...
        <input type="submit" value="Login " name="save" style="background-color:#000000;height:50px;width:350px"/>
