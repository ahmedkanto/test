...
{	
	...
	mysqli_query($con,"update subject set subject_name='$subname', sem_id='$s', teacher_id='$t', lecture_per_week='$lpw', type='$type' where subject_id='$subject_id' ");
...
<form method="POST" enctype="multipart/form-data">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
   ...
   <tr>
    <th width="237" scope="row">Term Name </th>
    <td width="213">
